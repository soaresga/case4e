...
# Forecast
#####                                          
lista_de_arimas = list()
paises = c('USA', 'MEX', 'CAN')
...
# Diversos estudos incorporam a hiótese de que o crescimento economico seja afetado somente pelo capital fisico, mas também pelo estoque de capital humano
# Outros estudos também apontam o nível de tecnologia local como um mecanismo de aumento de produtividade. 
